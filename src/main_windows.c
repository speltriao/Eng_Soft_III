...
//LER https://stackoverflow.com/questions/57729666/how-do-i-make-gtk-3-0-signal-handler-work-on-windows-10-using-msys2-and-mingw-w
...
G_MODULE_EXPORT void on_selection_changed(GtkWidget *c) { 
	gchar *value;
...
G_MODULE_EXPORT void on_btn_new_clicked(){
...
G_MODULE_EXPORT void on_btn_remover_clicked (){
	GtkTreeModel *model;
...
G_MODULE_EXPORT void on_adicionar_window_delete(){
    gtk_widget_hide_on_delete(adicionar_window);
}
G_MODULE_EXPORT void on_adicionar_window2_delete(){
...
G_MODULE_EXPORT void on_btn_ok_clicked(){
	g_print("Aqui");
...
G_MODULE_EXPORT void on_btn_ok2_clicked(){
...
G_MODULE_EXPORT void on_btn_cancelar_clicked(){
    clear_in();
}
G_MODULE_EXPORT void on_btn_cancelar2_clicked(){
	clear_in2();
}

G_MODULE_EXPORT void on_btn_clientes_pressed(){
	gtk_widget_show(tv1);
	gtk_widget_hide(tv2);
	gtk_widget_hide(tv3);
...
G_MODULE_EXPORT void on_btn_agenda_pressed(){
	gtk_widget_hide(tv1);
	gtk_widget_hide(tv3);
	gtk_widget_show(tv2);
...
G_MODULE_EXPORT void on_btn_funcionarios_pressed(){
	gtk_widget_hide(tv1);
	gtk_widget_hide(tv2);
	gtk_widget_hide(out_datahora);
	gtk_widget_show(tv3);
...
G_MODULE_EXPORT void on_btn_pesquisar_clicked(){
	gtk_widget_show(pesquisar_window);
}

G_MODULE_EXPORT void on_btn_cancelar3_clicked(){
	gtk_widget_hide(pesquisar_window);
}

G_MODULE_EXPORT void on_about_item_activate(){
	gtk_widget_show(sobre_window);
}

G_MODULE_EXPORT void on_ok_btn_clicked(){
	gtk_widget_hide(sobre_window);
}

G_MODULE_EXPORT void on_teste_clicked(){
	gtk_widget_show(sobre_window);
}

G_MODULE_EXPORT void on_btn_cancelar1_clicked(){
	clear_in3();
	gtk_widget_hide(adicionar_window3);
}

G_MODULE_EXPORT void on_btn_ok1_clicked(){
...
G_MODULE_EXPORT void on_ok_btn_4_clicked(){
